 ...
 * Rompe las cosas: Cambia un `;` por un `:`, borra una comilla, cambia un int por un String. Ver cómo falla el programa te enseña más que verlo funcionar.
 * El error es tu amigo: La consola no te está gritando, te está dando pistas de qué falta.
